...
- Campaign page overlay: `src/components/pulse/` —
  ...
  - `labs.jsx` + Y · Labs skin (default) — Figma "Design Labs" node 11603-48887 (fileKey 8rB3KQsQhmJrnQk3EFkcDx): U's tracking bar on top; below, Figma card system — column bg #f9fafb (`cp-crew-mode--labs`), white 12px-radius cards w/ #e3e3e3 borders + icon-chip headers (#f5f3fc), real Creators TABLE (CREATOR/LATEST UPDATE/STAGE cols, #fafafa header strip, verified badge #0c8ee9, purple stage dashes, always-on "＋ Request more", rows expand to the cp-hist timeline), Labs versions of While-you-were-away/Up next/The pace (lavender caption pill). Table LEFT, 344px rail RIGHT (flipped vs other variants). `.lb-li p` pins color — captured-page CSS colors bare <p> maroon.
