...
- Campaign page overlay: `src/components/pulse/` —
  ...
  - `CampaignPulse.jsx` — crew view shell + demo scrubber. Variants: V gray+crew · W +live bar · X +call fixes (D1 Katie welcome, D3 big review CTA / orange ready rows / request-more).
